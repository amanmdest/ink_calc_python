class Calculator:
    #para limitar o acesso a um atributo, colocar 2 "underscore" no inicio do mesmo
    ...
    def calcular_litragem_necessaria(self):
        if self.__area_paredes <= 0 or self.__area_teto <= 0:
            ...
            exit()
        return (self.__area_paredes + self.__area_teto) / 10 #10 = rendimento da tinta

#self indica que se trata de um atributo dentro da classe e não de uma nova variável
